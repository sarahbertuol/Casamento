    ...
    <SectionReveal className="flex flex-col items-center gap-5 py-14 text-center">
      ...
      <div className="flex gap-3">
        <a
          ...
          className="label-caps rounded-full border-2 border-wine px-5 py-2.5 text-[0.65rem] text-wine transition-colors hover:bg-wine hover:text-[#fff]"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="label-caps rounded-full border-2 border-gold px-5 py-2.5 text-[0.65rem] text-gold transition-colors hover:bg-gold hover:text-[#fff]"
        >
