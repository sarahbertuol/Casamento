        ...
        <dl className="w-full space-y-5 text-base">
          ...
          <div className="relative flex flex-col gap-0.5">
            <Image
              ...
              width={2187}
              height={1458}
              className="absolute top-1/2 -translate-y-1/2 right-full translate-x-[80px] md:translate-x-[64px] z-50 w-[120px] md:w-[280px] lg:w-[360px] h-auto mix-blend-multiply"
            />
          ...
          <div className="relative flex flex-col gap-0.5">
            ...
            <Image
              ...
              width={1090}
              height={866}
              className="absolute top-1/2 -translate-y-1/2 left-full -translate-x-[120px] md:-translate-x-[64px] z-50 w-[160px] md:w-[240px] lg:w-[300px] h-auto mix-blend-multiply"
            />
          </div>
        </dl>
      </div>
