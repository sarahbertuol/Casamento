    ...
    <SectionReveal className="flex flex-col items-center gap-6 py-14 text-center">
      ...
      {sent ? (
        ...
        >
          ...
          <button
            type="submit"
            className="label-caps mt-2 flex items-center justify-center gap-2 rounded-full border-2 border-wine px-8 py-3 text-sm text-wine transition-colors hover:bg-wine hover:text-white"
          >
